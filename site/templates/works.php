...
?>
        ...
        <p class="tagsp" onclick="showtags()"><span id="showtags">sort by tag <span style="color: rgb(190, 54, 36)">▾</span></span></p>
        ...
        <?php foreach($tags as $tag): ?>
            ...
            <?= html($tag) ?></a>&nbsp; 
        <?php endforeach ?><a class="email" id="showalltagssection" href="/works">show all</a>
        </p></div>
